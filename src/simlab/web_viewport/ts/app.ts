...
function renderSceneTree(scene: Scene, selectedActorId: string | null): void {
  ...
  for (const button of tree.querySelectorAll<HTMLButtonElement>('[data-actor-id]')) {
...
function renderInspector(actor: Actor | undefined): void {
