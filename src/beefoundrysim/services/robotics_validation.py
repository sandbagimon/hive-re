...
from beefoundrysim.models.robotics import Articulation, RoboticsModel, Sensor
...
def _schema_path() -> Path:
    ...
    installed_path = Path(sys.prefix) / "share" / "beefoundrysim" / "schemas" / "robotics.schema.json"
