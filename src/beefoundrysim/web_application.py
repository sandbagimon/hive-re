...
from beefoundrysim.services.mjcf_exporter import export_scene_to_mjcf
...
from beefoundrysim.services.project_service import load_scene, save_scene, validate_scene
from beefoundrysim.services.simulation_service import SimulationService
from beefoundrysim.simulation.runtime import RuntimePreflightReport
from beefoundrysim.simulation.runtime_registry import RuntimeBackendRegistry


class WebApplication:
    """Transport-neutral BeeFoundrySim application boundary used by the web server."""
    ...
    def _title(self, scene_name: str) -> str:
        ...
        return f"{dirty}BeeFoundrySim - {scene_name}{path}"
