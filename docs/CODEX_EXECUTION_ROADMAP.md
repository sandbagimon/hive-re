...
> 将 JointTrajectoryPlayer 接入 MuJoCo Session：每个 physics step 前更新 position targets；扩展
> SimulationState trajectory 状态，并增加 load/play/pause/stop Bridge RPC 与外部机械臂验收。
