...
function surfaceSample(kind, x, y) {
...
export function applyProceduralSurface(material, kind, options) {
    const size = 256;
    ...
    if (!colorContext || !heightContext || !roughnessContext)
        return;
...
export function createProceduralEnvironmentTexture() {
